...
from torchvision.datasets import SVHN as SVHN_torch
...
class SVHN(VisionDataset):
    ...
    def __init__(self, root, split='train', transform=None, target_transform=None,
        ...
        self.preprocess()
        self.normalize(dataset=SVHN_torch(root))
    ...
    def normalize(self, dataset) :
        data = dataset.data.astype(np.float32) / 255
...
class SVHN_idx(VisionDataset):
    ...
    def __init__(self, root, split='train', transform=None, target_transform=None,
        ...
        self.preprocess()
        self.normalize(dataset=SVHN_idx(root))
    def __getitem__(self, index):
        """
        Args:
            index (int): Index
    ...
    def normalize(self, dataset) :
        data = dataset.data.numpy().astype(np.float32) / 255
        self.mean = np.mean(data)
        self.std = np.std(data)
        self.data = (self.data - self.mean) / self.std
